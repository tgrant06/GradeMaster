...
OutputBaseFilename=GradeMasterSetup_slim_v{#MyAppVersion}_win-arm64{#InstallerSuffix}
...
Source: "{#SourcePath}..\..\Src\Client\GradeMaster.DesktopClient\bin\Publish\win-arm64\GradeMaster\bin\win-arm64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs external
