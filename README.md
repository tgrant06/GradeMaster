...
### Total Downloads
[![Total Downloads](https://img.shields.io/github/downloads/DevT06/GradeMaster/total)](https://github.com/DevT06/GradeMaster/releases)
...
There might be more major versions of GradeMaster, for example updating the .NET version from 9 (currently) to .NET 10 in November to this year.
