...
public class WeightConfiguration : IEntityTypeConfiguration<Weight>
{
    public void Configure(EntityTypeBuilder<Weight> builder)
    {
        ...
        builder.HasData(new List<Weight>
        {
            ...
            new Weight {Id = 8, Name = "66.7%", Value = 0.66667m},
            new Weight {Id = 9, Name = "62.5%", Value = 0.625m},
            new Weight {Id = 10, Name = "60%", Value = 0.6m},
            new Weight {Id = 11, Name = "50%", Value = 0.5m},
            new Weight {Id = 12, Name = "40%", Value = 0.4m},
            new Weight {Id = 13, Name = "37.5%", Value = 0.375m},
            new Weight {Id = 14, Name = "33.3%", Value = 0.33333m},
            new Weight {Id = 15, Name = "30%", Value = 0.3m},
            new Weight {Id = 16, Name = "25%", Value = 0.25m},
            new Weight {Id = 17, Name = "20%", Value = 0.2m},
            new Weight {Id = 18, Name = "12.5%", Value = 0.125m},
            new Weight {Id = 19, Name = "10%", Value = 0.1m},
            // seldom ones: scraped
